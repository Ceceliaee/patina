...
export const MESSAGES = {
  "export.fieldsSectionTitle": "Campos",
  "export.collapseFieldGroup": "Contraer",
  "export.configFields": "Configurar",
  ...
  "export.dialogDescription": "Elige el período, el formato y los campos.",
  ...
  "export.fields.app_name.label": "Nombre de la app",
  ...
  "export.fields.category.desc": "Nombre de categoría según las reglas actuales de app o dominio",
  ...
  "export.fields.record_type.desc": "session (app local) o web (navegación)",
  "export.fields.record_type.label": "Tipo de registro",
  "export.fields.session_id.desc": "ID de fila de la sesión de app local",
  "export.fields.session_id.label": "ID de sesión",
  "export.fields.source_key.desc": "Ejecutable para apps, dominio normalizado para web",
  "export.fields.source_key.label": "Clave de origen",
  "export.fields.source_name.desc": "Nombre de la app o del dominio web",
  ...
  "export.formatCSVHint": "Para Excel y otras hojas de cálculo.",
  "export.formatLabel": "Formato",
  "export.formatMarkdown": "Markdown",
  "export.formatMarkdownHint": "Para leer, editar y organizar notas.",
  "export.formatParquet": "Parquet",
  "export.formatParquetHint": "Para análisis y procesamiento por columnas.",
  "export.formatSQLite": "SQLite",
  "export.formatSQLiteHint": "Para consultas SQL locales y archivos completos.",
  ...
  "export.groupApps": "Información de apps",
