...
export const MESSAGES = {
  ...
  "widget.currentlyIdle": "当前空闲",
  "widget.currentSustainedRecording": "当前活动持续计入",
  "widget.error": "异常",
  "widget.idle": "空闲",
  "widget.loadingAppName": "挂件",
  ...
  "widget.trackingPaused": "追踪已暂停",
  "widget.trackingService": "追踪服务",
  "widget.windowExcluded": "当前窗口不写入记录"
} as const;
