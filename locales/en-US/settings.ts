...
export const MESSAGES = {
  "settings.timeRulesTitle": "Time rules",
  "settings.recordingOptionsTitle": "Recording options",
  "settings.themeGroupTitle": "Theme",
  "settings.interfaceGroupTitle": "Interface",
  "settings.windowBehaviorTitle": "Window behavior",
  "settings.runtimeBehaviorTitle": "Runtime behavior",
