...
export const MESSAGES = {
  ...
  "tools.activityReminderAppPlaceholder": "Type or select an app",
  "tools.activityReminderCandidatesLoadFailed": "Could not load available targets.",
  "tools.activityReminderCategoryPlaceholder": "Select a category",
  "tools.activityReminderDisable": "Disable",
  "tools.activityReminderEmpty": "No activity rules for this target type",
  "tools.activityReminderRulesTitle": "Activity rules",
  ...
  "tools.activityReminderTargetRequired": "Select an available target.",
  "tools.activityReminderWebPlaceholder": "Type or select a website",
  "tools.activityReminderWebSourceEmpty": "No recorded websites are available. Existing rules remain visible and paused while Web Activity is off.",
  ...
  "tools.activityReminderDurationInvalid": "Daily limit must be between 1 and 1440 minutes.",
