...
export const MESSAGES = {
  ...
  "tools.reminderModeSoftware": "App",
  ...
  "tools.softwareReminderActive": "Active",
  "tools.softwareReminderAppLabel": "App",
  "tools.softwareReminderAppPlaceholder": "Type or select app",
  "tools.softwareReminderAppRequired": "Select a recorded app.",
  ...
  "tools.softwareReminderDisable": "Disable",
  "tools.softwareReminderDurationInvalid": "Daily limit must be at least 1 minute.",
  "tools.softwareReminderDurationLabel": "Daily limit (min)",
  "tools.softwareReminderEmpty": "No app rules",
  "tools.softwareReminderMessageLabel": "Message",
  "tools.softwareReminderMessagePlaceholder": "Example: take a break",
  "tools.softwareReminderRulesTitle": "App rules",
  "tools.start": "Start",
