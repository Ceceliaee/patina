...
export const MESSAGES = {
  "settings.timeRulesTitle": "Правила времени",
  "settings.recordingOptionsTitle": "Параметры записи",
  "settings.themeGroupTitle": "Тема",
  "settings.interfaceGroupTitle": "Интерфейс",
  "settings.windowBehaviorTitle": "Поведение окна",
  "settings.runtimeBehaviorTitle": "Поведение при работе",
