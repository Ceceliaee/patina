...
export const MESSAGES = {
  ...
  "about.supportDialog.wechatAlt": "Код для поддержки через WeChat",
  "about.supportDialog.wechatTitle": "Код для поддержки через WeChat",
  "about.title": "О программе",
  "about.versionUnknown": "Версия неизвестна"
} as const;
