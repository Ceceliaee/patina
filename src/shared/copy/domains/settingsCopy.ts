const ZH_CN_SETTINGS_COPY = {
  settings: {
    ...
    useSystemNotificationsLabel: "使用系统通知",
    useSystemNotificationsHint: "工具到期时使用系统通知代替应用内弹窗。",
    enableSystemNotificationsLabel: "系统通知",
    enableSystemNotificationsHint: "工具到期时发送系统通知。",
    enableInAppNotificationsLabel: "应用内通知",
    enableInAppNotificationsHint: "工具到期时显示应用内弹窗。",
    ...
    toolsTitle: "工具",
    reminderSnoozeLabel: "提醒器延后间隔",
    reminderSnoozeHint: "提醒触发后，点击「稍后提醒」将在指定分钟后再次触发该提醒。",
    pomodoroSnoozeLabel: "番茄钟临时提醒间隔",
    pomodoroSnoozeHint: "点击通知中的「稍后提醒」时，将在指定分钟后创建一条临时提醒重新提示。番茄钟自身的阶段计时不受影响。",
    countdownSnoozeLabel: "倒计时追加时长",
    countdownSnoozeHint: "倒计时结束后，点击「再次计时」将增加指定时长并重新开始倒计时。",
    storage: {
...
const EN_US_SETTINGS_COPY = {
  settings: {
    ...
    useSystemNotificationsLabel: "Use system notifications",
    useSystemNotificationsHint: "Use OS notifications instead of in-app alerts for tool reminders.",
    enableSystemNotificationsLabel: "System notifications",
    enableSystemNotificationsHint: "Send OS notifications when tools are due.",
    enableInAppNotificationsLabel: "In-app notifications",
    enableInAppNotificationsHint: "Show in-app dialogs when tools are due.",
    ...
    toolsTitle: "Tools",
    reminderSnoozeLabel: "Reminder snooze interval",
    reminderSnoozeHint: "When a reminder fires, tapping 'Snooze' delays the reminder by this many minutes.",
    pomodoroSnoozeLabel: "Pomodoro snooze interval",
    pomodoroSnoozeHint: "When snoozing a pomodoro notification, creates a temporary reminder after this many minutes. The pomodoro cycle is not affected.",
    countdownSnoozeLabel: "Countdown add time",
    countdownSnoozeHint: "When a countdown finishes, tapping 'Add time' adds this many extra minutes and restarts the countdown.",
    storage: {
