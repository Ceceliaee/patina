const ZH_CN_SETTINGS_COPY = {
  settings: {
    ...
    dataExportTitle: "导出与导入",
    dataExportHint: "导出已有活动记录；导入外部时间数据。",
    dataExportAction: "导出",
    dataExportActionHint: "按需导出活动记录。",
    dataImportAction: "导入",
    dataImportActionHint: "导入或转换外部数据。",
    importRecordCount: (count: number) => `${count} 条导入记录`,
    dataImport: {
      dialogTitle: "选择导入方式",
      dialogDescription: "导入通用 CSV，或先转换外部数据。",
      csvTitle: "导入 CSV",
      csvHint: "选择通用 CSV 文件导入。",
      destructureTitle: "解构工具",
      destructureHint: "将外部文件转换为通用 CSV。",
      destructureFormatsHint: "目前支持：\nCSV 文件（.csv）：Tai\nSQLite 文件（.db、.sqlite）：Tai、Taix",
      previewTitle: "导入预览",
      fileLabel: "导入文件",
      detailSeparator: "：",
      availableLabel: "可导入记录",
      exactLabel: "精确记录",
      hourLabel: "小时汇总",
      duplicateLabel: "重复记录",
      errorLabel: "无效记录",
      categorizedAppsLabel: "含分类应用",
      ...
      batchesDescription: "仅删除所选导入批次；Patina 原生数据不受影响。",
    ...
    backupRestoreActionHelp: "旧版备份格式：结构化数据备份\n当前备份格式：SQLite 数据快照\n旧版恢复兼容至：2026 年 10 月 18 日",
    ...
    restoreSourceRemoteHint: "选择 WebDAV 备份文件。",
...
const EN_US_SETTINGS_COPY = {
  settings: {
    ...
    dataExportTitle: "Export and import",
    dataExportHint: "Export existing activity records. Import external time data.",
    dataExportAction: "Export",
    dataExportActionHint: "Export activity records as needed.",
    dataImportAction: "Import",
    dataImportActionHint: "Import or convert external data.",
    importRecordCount: (count: number) => `${count} imported records`,
    dataImport: {
      dialogTitle: "Choose import method",
      dialogDescription: "Import a canonical CSV, or convert external data first.",
      csvTitle: "Import CSV",
      csvHint: "Choose a canonical CSV file to import.",
      destructureTitle: "Destructure tool",
      destructureHint: "Convert an external file to a canonical CSV.",
      destructureFormatsHint: "Currently supported:\nCSV files (.csv): Tai\nSQLite files (.db, .sqlite): Tai, Taix",
      previewTitle: "Import preview",
      fileLabel: "Import file",
      detailSeparator: ": ",
      availableLabel: "Ready to import",
      exactLabel: "Exact records",
      hourLabel: "Hourly totals",
      duplicateLabel: "Duplicate records",
      errorLabel: "Invalid records",
      categorizedAppsLabel: "Apps with categories",
      ...
      batchesDescription: "Only the selected import batch is deleted. Patina's native data is unaffected.",
    ...
    restoreSourceRemoteHint: "Choose a WebDAV backup file.",
