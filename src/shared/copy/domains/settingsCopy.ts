const ZH_CN_SETTINGS_COPY = {
  settings: {
    ...
    sustainedParticipationGraceWindowLabel: "信号丢失等待",
    sustainedParticipationGraceWindowHint: "信号短暂丢失时，保留已开启的持续追踪状态。",
    residentTitle: "常驻",
    ...
    privacyModeHint: "启用后，浏览器插件同步的网址、标题和图标将不在软件内存储和显示，仅记录域名。",
    blacklistTitle: "黑名单",
    blacklistAppsLabel: "应用黑名单",
    blacklistAppsHint: "被列入黑名单的应用将不被追踪。",
    blacklistDomainsLabel: "域名黑名单",
    blacklistDomainsHint: "被列入黑名单的域名将不被记录网页活动。",
    blacklistAddApp: "添加应用",
    blacklistAddDomain: "添加域名",
    blacklistRemoveApp: "移出黑名单",
    blacklistRemoveDomain: "移出黑名单",
    blacklistAddAppPlaceholder: "输入可执行文件名，如 chrome.exe",
    blacklistAddDomainPlaceholder: "输入域名，如 example.com",
    blacklistEmpty: "暂无黑名单条目",
    blacklistAddTitle: "添加到黑名单",
    blacklistAddAppConfirm: "添加",
    blacklistAddDomainConfirm: "添加",
    scanDirsTitle: "自定义扫描目录",
    scanDirsHint: "添加额外目录以扫描便携版软件的可执行文件。",
    scanDirsAdd: "添加目录",
    scanDirsRemove: "移除",
    scanDirsScan: "扫描",
    scanDirsScanning: "正在扫描...",
    scanDirsEmpty: "暂无自定义扫描目录",
    scanDirsScanResultTitle: "扫描结果",
    scanDirsScanResultCount: "找到 {count} 个可执行文件",
    scanDirsScanResultEmpty: "未找到可执行文件",
    scanDirsScanResultClassify: "自动分类",
    ...
    parquetExportTitle: "Parquet 导出",
    parquetExportHint: "将会话和网页数据导出为 Parquet 格式",
    parquetExportAction: "导出",
    parquetExporting: "导出中...",
    parquetExportDone: (count: number) => `已导出 ${count} 条记录`,
    parquetExportFailed: "导出失败",
    parquetExportPathPlaceholder: "选择输出路径",
    parquetExportBrowse: "浏览",
    parquetExportFieldSession: "会话字段",
    parquetExportFieldWeb: "网页字段",
...
const EN_US_SETTINGS_COPY = {
  settings: {
    ...
    sustainedParticipationGraceWindowLabel: "Signal drop grace",
    sustainedParticipationGraceWindowHint: "Keep sustained tracking active during brief signal loss.",
    ...
    privacyModeHint: "When enabled, website URLs, titles, and icons synced from the browser extension will not be stored or displayed — only domains are recorded.",
    blacklistTitle: "Blacklist",
    blacklistAppsLabel: "Blacklisted apps",
    blacklistAppsHint: "Blacklisted apps will not be tracked.",
    blacklistDomainsLabel: "Blacklisted domains",
    blacklistDomainsHint: "Blacklisted domains will not have web activity recorded.",
    blacklistAddApp: "Add app",
    blacklistAddDomain: "Add domain",
    blacklistRemoveApp: "Remove from blacklist",
    blacklistRemoveDomain: "Remove from blacklist",
    blacklistAddAppPlaceholder: "Enter exe name, e.g. chrome.exe",
    blacklistAddDomainPlaceholder: "Enter domain, e.g. example.com",
    blacklistEmpty: "No blacklist entries",
    blacklistAddTitle: "Add to blacklist",
    blacklistAddAppConfirm: "Add",
    blacklistAddDomainConfirm: "Add",
    scanDirsTitle: "Custom scan directories",
    scanDirsHint: "Add directories to scan for portable app executables.",
    scanDirsAdd: "Add directory",
    scanDirsRemove: "Remove",
    scanDirsScan: "Scan",
    scanDirsScanning: "Scanning...",
    scanDirsEmpty: "No custom scan directories",
    scanDirsScanResultTitle: "Scan results",
    scanDirsScanResultCount: "Found {count} executables",
    scanDirsScanResultEmpty: "No executables found",
    scanDirsScanResultClassify: "Auto-classify",
    ...
    parquetExportTitle: "Parquet export",
    parquetExportHint: "Export sessions and web activity as Parquet",
    parquetExportAction: "Export",
    parquetExporting: "Exporting...",
    parquetExportDone: (count: number) => `Exported ${count} records`,
    parquetExportFailed: "Export failed",
    parquetExportPathPlaceholder: "Choose output path",
    parquetExportBrowse: "Browse",
    parquetExportFieldSession: "Session fields",
    parquetExportFieldWeb: "Web fields",
