const ZH_CN_SETTINGS_COPY = {
  settings: {
    ...
    screenshotIntervalPreset5m: "5 分钟",
    screenshotIntervalPreset10m: "10 分钟",
    screenshotIntervalCustom: "自定义",
    screenshotIntervalCustomLabel: "自定义间隔",
    screenshotStorageWarning: (count: number, size: string) =>
      `请注意：按当前设置，24 小时将生成 ${count} 张截图，预计占用 ${size} 存储空间，请定期删除截图或在不需要时关闭该功能`,
    screenshotRetentionLabel: "自动删除",
    screenshotRetentionHint: "自动删除超过保留期限的截图，释放存储空间。",
    screenshotRetentionPreset1d: "1 天",
    screenshotRetentionPreset7d: "7 天",
    screenshotRetentionCustom: "自定义",
    screenshotRetentionCustomLabel: "保留期限",
    screenshotRetentionDays: (days: number) => `${days} 天`,
    residentTitle: "常驻",
    ...
    dataExportHint: "导出会话和网页活动，用于表格查看、归档或分析。",
    dataExportAction: "导出",
...
const EN_US_SETTINGS_COPY = {
  settings: {
    ...
    screenshotsEnabledLabel: "Work screenshots",
    screenshotsEnabledHint: "Auto-capture every 60 seconds and keep in the timeline. Screenshots are stored locally only.",
    screenshotIntervalLabel: "Screenshot interval",
    screenshotIntervalHint: "Set the interval for automatic screenshots. Shorter intervals use more storage.",
    screenshotIntervalPreset1m: "1 min",
    screenshotIntervalPreset5m: "5 min",
    screenshotIntervalPreset10m: "10 min",
    screenshotIntervalCustom: "Custom",
    screenshotIntervalCustomLabel: "Custom interval",
    screenshotStorageWarning: (count: number, size: string) =>
      `Note: At current settings, 24 hours will generate ${count} screenshots, estimated ${size} of storage. Please delete screenshots regularly or disable when not needed.`,
    screenshotRetentionLabel: "Auto-delete",
    screenshotRetentionHint: "Automatically delete screenshots older than the retention period to free up storage.",
    screenshotRetentionPreset1d: "1 day",
    screenshotRetentionPreset7d: "7 days",
    screenshotRetentionCustom: "Custom",
    screenshotRetentionCustomLabel: "Retention period",
    screenshotRetentionDays: (days: number) => `${days} days`,
    ...
    dataExportHint: "Export sessions and web activity for spreadsheets, archives, or analysis.",
