        ...
        <div className="data-trend-inline-metrics" aria-label={UI_TEXT.accessibility.data.trendSummary}>
          <div className="data-trend-inline-metric">
            ...
            <button
              ...
              onClick={toggleTotal}
              aria-label={`${isTotalVisible ? "隐藏" : "显示"}${UI_TEXT.data.duration}`}
            >
        ...
        <div className="data-trend-expanded-metrics">
          <div className="data-trend-inline-metric">
            ...
            <button
              ...
              className="data-trend-curve-toggle"
              onClick={toggleApp}
              aria-label={`${isAppVisible ? "隐藏" : "显示"}${UI_TEXT.data.appTime}`}
            >
          ...
          <div className="data-trend-inline-metric">
            ...
            <button
              ...
              className="data-trend-curve-toggle"
              onClick={toggleWeb}
              aria-label={`${isWebVisible ? "隐藏" : "显示"}${UI_TEXT.data.webTime}`}
            >
