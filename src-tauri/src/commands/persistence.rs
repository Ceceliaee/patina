...
pub async fn cmd_delete_sessions_before<R: Runtime>(
    ...
    user_data_maintenance::delete_sessions_before(&app, cutoff_time).await
}
...
pub async fn cmd_clear_all_session_window_titles<R: Runtime>(
    ...
    user_data_maintenance::clear_all_session_window_titles(&app).await
}
...
pub async fn cmd_delete_sessions_by_exe_names<R: Runtime>(
    ...
    user_data_maintenance::delete_sessions_by_exe_names(&app, exe_names).await
}
...
pub async fn cmd_delete_web_activity_segments_before<R: Runtime>(
    ...
    user_data_maintenance::delete_web_activity_segments_before(&app, cutoff_time).await
}
...
pub async fn cmd_delete_web_activity_segments_by_domain<R: Runtime>(
    ...
    user_data_maintenance::delete_web_activity_segments_by_domain(&app, normalized_domain).await
}
...
pub async fn cmd_save_remote_backup_settings<R: Runtime>(
    ...
    settings_payload_service::save_remote_backup_settings(&app, patch.into()).await
}
...
pub async fn cmd_save_remote_backup_remote_dir<R: Runtime>(
    ...
    settings_payload_service::save_remote_backup_remote_dir(&app, remote_dir).await
}
...
pub async fn cmd_save_remote_backup_last_backup_at<R: Runtime>(
    ...
    settings_payload_service::save_remote_backup_last_backup_at(&app, timestamp_ms).await
}

#[tauri::command]
pub async fn cmd_clear_remote_backup_settings<R: Runtime>(app: AppHandle<R>) -> Result<(), String> {
    settings_payload_service::clear_remote_backup_settings(&app).await
}
...
pub async fn cmd_save_data_bootstrap_snapshot_payload<R: Runtime>(
    ...
    settings_payload_service::save_data_bootstrap_snapshot_payload(&app, payload).await
}
...
pub async fn cmd_clear_data_bootstrap_snapshot_payload<R: Runtime>(
    ...
    settings_payload_service::clear_data_bootstrap_snapshot_payload(&app).await
}
