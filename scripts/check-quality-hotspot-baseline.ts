...
const HOTSPOT_BUDGETS: HotspotBudget[] = [
  ...
  { path: "src/styles/quiet-pro.css", owner: "Quiet Pro design system", maxLines: 2036 },
  ...
  { path: "src/features/history/components/History.tsx", owner: "history feature UI", maxLines: 1340 },
