...
- 修复 Microsoft Store、计算器等由 Windows 系统窗口宿主承载的包应用无法记录的问题；现在会以真实应用身份保存活动，并从系统应用项读取本地化名称和图标，同时继续排除宿主进程与系统表面。Refs [#75](https://github.com/Ceceliaee/patina/issues/75)
